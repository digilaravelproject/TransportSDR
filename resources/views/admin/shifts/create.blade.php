...
<div class="row align-items-center mb-4">
    <div class="col">
        <h2 class="fw-bold mb-0">Create New Shift</h2>
        <p class="text-muted">Add a new shift schedule</p>
    </div>
    <div class="col-auto">
            ...
            <div class="card-body">
                <form action="{{ route('admin.shifts.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Add shift details...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                    ...
                                    <option value="overtime" @selected(old('type') === 'overtime')>Overtime</option>
                                    <option value="night" @selected(old('type') === 'night')>Night</option>
                            ...
                            @foreach(['1' => 'Monday', '2' => 'Tuesday', '3' => 'Wednesday', '4' => 'Thursday', '5' => 'Friday', '6' => 'Saturday', '7' => 'Sunday'] as $day => $name)
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="days[]" value="{{ $day }}" id="day{{ $day }}" @checked(in_array($day, old('days', [])))>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('max_drivers') is-invalid @enderror" id="max_drivers" name="max_drivers" value="{{ old('max_drivers') }}" min="1" placeholder="Leave empty for unlimited">
                                @error('max_drivers')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('hourly_rate') is-invalid @enderror" id="hourly_rate" name="hourly_rate" value="{{ old('hourly_rate') }}" step="0.01" min="0" placeholder="Optional">
                                @error('hourly_rate')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-footer">
                        ...
                        <button type="submit" class="btn btn-secondary">Create Shift</button>
                    </div>
                </form>
            </div>
        </div>
