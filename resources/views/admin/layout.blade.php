        ...
        <div class="sidebar p-0">
            <div class="p-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if(Route::currentRouteName() == 'admin.plans.index') active @endif" href="{{ route('admin.plans.index') }}">
                            <i class="fas fa-list me-2"></i>
                            Manage Plans
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if(Route::currentRouteName() == 'admin.subscriptions.index') active @endif" href="{{ route('admin.subscriptions.index') }}">
