...
<body style="font-family:Arial,sans-serif;background:#f5f5f5;padding:20px;">
    <div style="max-width:460px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;">
        ...
        <div style="padding:30px;">
            ...
            <div
                style="background:#fff5f5;border:2px dashed #e74c3c;border-radius:8px;text-align:center;padding:20px;margin:20px 0;">
                <div style="font-size:38px;font-weight:bold;color:#c0392b;letter-spacing:10px;">{{ $otp }}</div>
